...
The Peridio CLI is simply a wrapper around our RESTful API. [Full documentation for the CLI is available here.](https://docs.core.peridio.com/peridio-core/tools/peridio-cli)
...
Go ahead and download the `peridio` cli from our releases page on Github [here](https://docs.core.peridio.com/peridio-core/tools/peridio-cli).
...
The Peridio CLI has a convenience command for configuring new profiles: `peridio config profiles create` ([docs here](https://docs.core.peridio.com/peridio-cli/config/profiles/create)).
...
If you _want_ to see where this information is stored, you can see it in these two files. _Note: This assumes a macOS operating system. For other platforms, see here: [CLI Configuration Files](https://docs.core.peridio.com/peridio-core/tools/peridio-cli#configuration-files)._
...
_For a more manual process of creating signing keys, see our [guide on creating signing keys here](https://docs.core.peridio.com/platform/guides/creating-signing-keys)._
